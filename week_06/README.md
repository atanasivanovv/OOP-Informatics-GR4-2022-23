...
Накрая в main.cpp импортваме **header cpp файла!**
...
При компилация вече ще компилираме с `g++ *.cpp`, за да можем компилатора да разбере както за имплементацията на `main`, така и на имплементациите на съдържанието на `header` файловете
